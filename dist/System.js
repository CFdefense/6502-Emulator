...
const ProgramMenu_1 = require("./lib/ProgramMenu");
/*
  System.ts
...
class System extends Hardware_1.Hardware {
    constructor(debugMode) {
        ...
        this.programOutput = '';
        this._MEMORY = new Memory_1.Memory(debugMode);
        this._MMU = new MMU_1.MMU(this._MEMORY, debugMode);
        this._CPU = new Cpu_1.Cpu(this._MMU, this, debugMode);
        this._CLOCK = new Clock_1.Clock(CLOCK_INTERVAL, debugMode);
        this._INTERRUPTCONTROLLER = new InterruptController_1.InterruptController(this._CPU, debugMode);
        this._KEYBOARD = new Keyboard_1.Keyboard(this._INTERRUPTCONTROLLER, debugMode);
        this.running = false;
        this._KEYBOARD.setSilentMode(true);
        this.programMenu = new ProgramMenu_1.ProgramMenu(this._CPU, this._INTERRUPTCONTROLLER, debugMode);
