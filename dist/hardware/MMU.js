...
class MMU extends Hardware_1.Hardware {
    constructor(memoryRef, debugMode) {
        super("0", "MMU", debugMode);
        this._PROGRAM = []; // Stack of bytes to load
        this._LOAD_ADDRESS = 0x0000; // Starting address for program
        this._isLoading = false; // Flag to indicate if we're still loading program
